...
N3351 does not recommend defining WeakOutputIterator or OutputIterator, prefering instead to define all the algorithms in terms of WeaklyIncrementable and Writable. We see no disadvantage to rolling these two into the familiar (Weak)OutputIterator concept as a convenience; it saves typing.
...
on the formulations of the algorithms as specified in [N3351][8][@n3351] has proven invaluable, and he has generously donated his time and expertise to expound on the ideas there and improve the quality of this proposal.
