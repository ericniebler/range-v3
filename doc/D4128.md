...
- Discuss how an extension to the Concepts Lite proposal, implicit conversion to concept, bears on the ConvertibleToRange/Range concpets and the way the algorithms are constrained.
