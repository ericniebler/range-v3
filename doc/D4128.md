...
##### Iterator Concepts
    ...
    concept Sentinel<Regular S, Iterator I> =
        EqualityComparable<S, I>;
    ...
    concept Iterator<WeakIterator I, Regular S = I> =
        EqualityComparable<I, S>;

    concept WeakOutputIterator<WeakIterator I, typename T> =
        Writable<I, T>;

    concept OutputIterator<Regular I, typename T, Regular S = I> =
        WeakOutputIterator<I, T> && EqualityComparable<I, S>;
    ...
    concept InputIterator<Regular I, Regular S = I> =
        WeakInputIterator<I> &&
        EqualityComparable<I, S> &&
        Derived<IteratorCategory<I>, input_iterator_tag>;

    concept ForwardIterator<Regular I, Regular S = I> =
        InputIterator<I, S> &&
        Incrementable<I> &&
        Derived<IteratorCategory<I>, forward_iterator_tag>;

    concept BidirectionalIterator<Regular I, Regular S = I> =
        ForwardIterator<I, S> &&
    ...
    concept RandomAccessIterator<Regular I, Regular S = I> =
...
##### Iterator Range Concepts
    ...
    concept IteratorRange<Regular I, Regular S> =
        Iterator<I, S>;

    concept SizedIteratorRange<Regular I, Regular S> =
        IteratorRange<I, S> &&
...
##### Range Concepts
    ...
    concept SizedIterable<Iterable T> =
        requires(T t) {
            SizeType<T>;
            Integral<SizeType>;
