...
namespace concepts
{
    inline namespace v1
    {
        ...
        // // Prior to llvm-3.8, std::is_destructible<T>::value was not constexpr,
        // // causing problems with the definition of the Destructible concept.
        // template <class T, template <class> class Tfx>
        // struct is_destructible_impl_
        //   : meta::and_<std::is_object<T>, Tfx<T>>
        // {};
        // template <class T, template <class> class Tfx>
        // struct is_destructible_impl_<T&, Tfx>
        //   : std::true_type
        // {};
        // template <class T, template <class> class Tfx>
        // struct is_destructible_impl_<T&&, Tfx>
        ...
        //   : std::false_type
        // {};
        // template <class T, std::size_t N, template <class> class Tfx>
        // struct is_destructible_impl_<T[N], Tfx>
        //   : is_destructible_impl_<T, Tfx>
        // {};
        // template <class T>
        // using _destr_type = decltype(std::declval<T&>().~T());
        // template <class T>
        // using _destr = meta::is_trait<meta::defer<_destr_type, T>>;
        // template <class T>
        // using _nothrow_destr_type = meta::if_c<noexcept(std::declval<T&>().~T())>;
        // template <class T>
        // using _nothrow_destr = meta::is_trait<meta::defer<_nothrow_destr_type, T>>;
        // template <class T>
        // struct is_destructible : is_destructible_impl_<T, _destr> {};
        // template <class T>
        // struct is_nothrow_destructible : is_destructible_impl_<T, _nothrow_destr> {};


        // template <class T, template <class> class Tfx>
        // struct is_destructible_impl_2_
        //   : Tfx<decltype(std::declval<U&>().~U())>
        // {};
        // template <class T, template <class> class Tfx>
        // struct is_destructible_impl_
        //   : is_destructible_impl_<T, Tfx>
        ...
        // template <class T, std::size_t N, template <class> class Tfx>
        // struct is_destructible_impl_<T[N], Tfx>
        //   : is_destructible_impl_<T>
        // {};
        // template <>
        // struct is_destructible_impl_<void>
        //   : std::false_type
        // {};
        // template <>
        // struct is_destructible_impl_<void const>
        //   : std::false_type
        // {};
        // template <>
        // struct is_destructible_impl_<void volatile>
        //   : std::false_type
        // {};
        // template <>
        // struct is_destructible_impl_<void const volatile>
        //   : std::false_type
        // {};
#else
