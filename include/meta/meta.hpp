...
namespace meta
{
    ...
    inline namespace v1
    {
        ...
        namespace detail
        {
            ...
            template <std::size_t End, typename State, indices_strategy_ _Status>
...
// clang-format on
        ...
        namespace detail
        {
            ...
            template <typename _Bool, typename... Bools>
            struct _and_<_Bool, Bools...>
                : if_c<!_Bool::type::value, std::false_type, _and_<Bools...>>
            {
            };
            ...
            template <typename _Bool, typename... Bools>
            struct _or_<_Bool, Bools...> : if_c<_Bool::type::value, std::true_type, _or_<Bools...>>
            {
            };
        } // namespace detail
        /// \endcond
        ...
        using not_ = not_c<_Bool::type::value>;
...
/// \ingroup logical
        ...
        namespace detail
        {
            ...
            private:
                ...
                template <typename _Bool, typename... Ts, typename Args>
                struct impl<defer<and_, _Bool, Ts...>, Args> // Short-circuit and_
                    : impl<lazy_impl_<lazy_if_<_Bool, lazy::and_<Ts...>, protect_<std::false_type>>,
                                      Args>,
                           Args>
                {
                };
                template <typename _Bool, typename... Ts, typename Args>
                struct impl<defer<or_, _Bool, Ts...>, Args> // Short-circuit or_
                    : impl<lazy_impl_<lazy_if_<_Bool, protect_<std::true_type>, lazy::or_<Ts...>>,
                                      Args>,
                           Args>
                {
                };
