...
namespace ranges
{
    ...
    template<typename ActionFn, typename Rng>
    CPP_concept_bool invocable_action_closure = invocable<ActionFn, Rng> && CPP_fragment(
        ranges::invocable_action_closure_, ActionFn, Rng);

    namespace defer
    {
        template<typename ActionFn, typename Rng>
        CPP_concept invocable_action_closure = CPP_defer(ranges::invocable_action_closure,
                                                         ActionFn, Rng);
    }
