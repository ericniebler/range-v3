    ...
    inline namespace v3
    {
        ...
        public:
            ...
            template<typename Rng1, typename I2Ref, typename C = equal_to, typename P1 = ident,
                ...
                CONCEPT_REQUIRES_(ConvertibleToForwardRange<Rng1>() && IsPermutationable<I1, I2, C, P1, P2>())>
            ...
            template<typename Rng1, typename Rng2, typename C = equal_to, typename P1 = ident,
                ...
                CONCEPT_REQUIRES_(ConvertibleToForwardRange<Rng1>() && ConvertibleToForwardRange<Rng2>() &&
                    IsPermutationable<I1, I2, C, P1, P2>())>
