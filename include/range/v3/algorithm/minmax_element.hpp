...
namespace ranges
{
    ...
    struct minmax_element_fn
    {
        ...
        minmax_element_result<I> operator()(I begin, S end, C pred = C{}, P proj = P{}) const
        {
        ...
        minmax_element_result<safe_iterator_t<Rng>> operator()(Rng &&rng, C pred = C{}, P proj = P{}) const
        {
