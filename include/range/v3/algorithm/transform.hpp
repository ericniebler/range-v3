    ...
    inline namespace v3
    {
        ...
        struct transform_fn
        {
            ...
            template<typename Rng, typename O, typename F, typename P = ident,
                ...
                CONCEPT_REQUIRES_(ConvertibleToRange<Rng>() && Transformable1<I, O, F, P>())>
            ...
            template<typename I0, typename S0, typename I1, typename S1, typename O, typename F,
                typename P0 = ident, typename P1 = ident,
                CONCEPT_REQUIRES_(Sentinel<S0, I0>() && Sentinel<S1, I1>() && Transformable2<I0, I1, O, F, P0, P1>())>
            ...
            template<typename Rng0, typename Rng1, typename O, typename F,
                ...
                CONCEPT_REQUIRES_(ConvertibleToRange<Rng0>() && ConvertibleToRange<Rng1>() && Transformable2<I0, I1, O, F, P0, P1>())>
            ...
            template<typename I0, typename S0, typename I1, typename O, typename F,
                typename P0 = ident, typename P1 = ident,
                CONCEPT_REQUIRES_(Sentinel<S0, I0>() && Transformable2<I0, I1, O, F, P0, P1>())>
            ...
            template<typename Rng0, typename I1, typename O, typename F,
                typename P0 = ident, typename P1 = ident,
                typename I0 = range_iterator_t<Rng0>,
                CONCEPT_REQUIRES_(ConvertibleToRange<Rng0>() && Transformable2<I0, I1, O, F, P0, P1>())>
