...
namespace ranges
{
    ...
    public:
        CPP_template(typename I0, typename S0, typename I1, typename C = equal_to,
        ...
        RANGES_DEPRECATED("Use the variant of ranges::equal that takes an upper bound for "
            "both sequences")
        constexpr /*c++14*/ bool operator()(I0 begin0, S0 end0, I1 begin1, C pred = C{},
        ...
        CPP_template(typename I0, typename S0, typename I1, typename S1, typename C = equal_to,
            typename P0 = identity, typename P1 = identity)(
            requires InputIterator<I0> && Sentinel<S0, I0> &&
                InputIterator<I1> && Sentinel<S1, I1> &&
                IndirectlyComparable<I0, I1, C, P0, P1>)
        constexpr /*c++14*/ bool operator()(I0 begin0, S0 end0, I1 begin1, S1 end1,
        ...
        CPP_template(typename Rng0, typename I1Ref, typename C = equal_to, typename P0 = identity,
        ...
        RANGES_DEPRECATED("Use the variant of ranges::equal that takes an upper bound for "
            "both sequences")
        constexpr /*c++14*/ bool operator()(Rng0 &&rng0, I1Ref &&begin1, C pred = C{},
                P0 proj0 = P0{}, P1 proj1 = P1{}) const
        {
        ...
        CPP_template(typename Rng0, typename Rng1, typename C = equal_to, typename P0 = identity,
            typename P1 = identity)(
            requires InputRange<Rng0> && InputRange<Rng1> &&
                IndirectlyComparable<iterator_t<Rng0>, iterator_t<Rng1>, C, P0, P1>)
        constexpr /*c++14*/ bool operator()(Rng0 &&rng0, Rng1 &&rng1, C pred = C{},
                P0 proj0 = P0{}, P1 proj1 = P1{}) const
        {
