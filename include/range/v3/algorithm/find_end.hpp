...
namespace ranges
{
    ...
    public:
        ...
        subrange<I1> operator()(I1 begin1, S1 end1, I2 begin2, S2 end2, R pred = R{}, P proj = P{}) const
        {
        ...
        CPP_template(typename Rng1, typename Rng2, typename R = equal_to, typename P = identity)(
            requires ForwardRange<Rng1> && ForwardRange<Rng2> &&
                IndirectRelation<R, projected<iterator_t<Rng1>, P>, iterator_t<Rng2>>)
        safe_subrange_t<Rng1> operator()(Rng1 &&rng1, Rng2 &&rng2, R pred = R{}, P proj = P{}) const
        {
