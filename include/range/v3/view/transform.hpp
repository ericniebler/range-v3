    ...
    inline namespace v3
    {
        ...
        public:
            ...
            iter_transform2_view(Rng1 rng1, Rng2 rng2, Fun fun)
              ...
              , rng2_(std::move(rng2))
            {}
            CONCEPT_requires(True<(my_cardinality >= 0)>())
            ...
            public:
                ...
                (
                    ...
                    concept TransformableRange,
                        ...
                        {
                            ranges::invoke(fun, *it) // implies non-void return
                        } &&
                        InputRange<Rng>() &&
                        CopyConstructible<Fun>()
                );
                ...
                (
                    ...
                    concept TransformableRanges,
                        ...
                        {
                            ranges::invoke(fun, *it1, *it2) // implies non-void return
                        } &&
                        InputRange<Rng1>() &&
                        InputRange<Rng2>() &&
                        CopyConstructible<Fun>()
                ...
                (void) operator()(Rng &&, Fun) const
                {
                    ...
                    CONCEPT_assert_msg(
                        meta::not_<Same<void, invoke_result_t<
