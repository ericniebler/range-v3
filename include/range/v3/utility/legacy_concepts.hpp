...
#ifndef RANGES_V3_UTILITY_LEGACY_CONCEPTS_HPP
#define RANGES_V3_UTILITY_LEGACY_CONCEPTS_HPP
...
namespace ranges
{
    inline namespace v3
    {
...
#endif
        {
            ...
            using WeaklyEqualityComparableWith = WeaklyEqualityComparable;
            ...
            using StrictTotallyOrdered = TotallyOrdered;
        ...
        {
            return static_cast<bool>(meta::_t<T>());
        }

        template<class T>
        constexpr bool True(T) noexcept
        {
            return static_cast<bool>(meta::_t<T>());
        }
