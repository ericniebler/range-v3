...
#ifndef RANGES_V3_CONTAINER_TAKE_HPP
#define RANGES_V3_CONTAINER_TAKE_HPP
    ...
    inline namespace v3
    {
        namespace cont
        {
            ...
            public:
                ...
                {
                    RANGES_ASSERT(n >= 0);
                    cont::erase(rng, next_bounded(begin(rng), n, end(rng)), end(rng));
                }
            };

            RANGES_CONSTEXPR action<take_fn> take{};
        }
    }
}
