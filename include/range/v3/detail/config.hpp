...
#define RANGES_CXX_ATTRIBUTE_NODISCARD_11 0L
#define RANGES_CXX_ATTRIBUTE_NODISCARD_14 0L
#define RANGES_CXX_ATTRIBUTE_NODISCARD_17 201603L
...
#if _MSC_VER >= 1910
#if _MSC_VER >= 1912
#ifndef RANGES_CXX_ATTRIBUTE_NODISCARD
#if _MSVC_LANG > RANGES_CXX_STD_14
#define RANGES_CXX_ATTRIBUTE_NODISCARD RANGES_CXX_ATTRIBUTE_NODISCARD_17
#else
#define RANGES_CXX_ATTRIBUTE_NODISCARD 0L
#endif
#endif // RANGES_CXX_ATTRIBUTE_NODISCARD
#ifndef RANGES_CXX_CONSTEXPR
#if _MSVC_LANG > RANGES_CXX_STD_14
#define RANGES_CXX_CONSTEXPR RANGES_CXX_CONSTEXPR_17
#else
#define RANGES_CXX_CONSTEXPR RANGES_CXX_CONSTEXPR_14
#endif
...
#endif
#if !defined(RANGES_CXX_RANGE_BASED_FOR) && defined(_MSVC_LANG) && _MSVC_LANG > RANGES_CXX_STD_14
#define RANGES_CXX_RANGE_BASED_FOR RANGES_CXX_RANGE_BASED_FOR_17
#endif
...
#define RANGES_DIAGNOSTIC_IGNORE_CXX17_EXTENSIONS
...
#define RANGES_DIAGNOSTIC_IGNORE_CXX17_EXTENSIONS RANGES_DIAGNOSTIC_IGNORE("-Wc++1z-extensions")
#else
...
#ifndef RANGES_CXX_ATTRIBUTE_NODISCARD
#ifdef __has_cpp_attribute
#define RANGES_CXX_ATTRIBUTE_NODISCARD __has_cpp_attribute(nodiscard)
#else
#define RANGES_CXX_ATTRIBUTE_NODISCARD RANGES_CXX_FEATURE(ATTRIBUTE_NODISCARD)
#endif
#endif
...
#if RANGES_CXX_ATTRIBUTE_NODISCARD >= RANGES_CXX_ATTRIBUTE_NODISCARD_17
#define RANGES_NODISCARD [[nodiscard]]
#else
#define RANGES_NODISCARD
#endif
#endif // RANGES_NODISCARD
