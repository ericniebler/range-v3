    ...
    inline namespace v3
    {
        ...
        namespace experimental
        {
              ...
              , private detail::coroutine_owner_::adl_hook
            {
                ...
                {
                    coroutine_owner{
                        ranges::exchange(base(), ranges::exchange(that.base(), {}))};
                    return *this;
                }
                ...
                base_t const &base() const noexcept
                {
                    return *this;
                }
            ...
            namespace detail
            {
                ...
                struct generator_promise
                {
                    ...
                    template<typename Arg,
                             CONCEPT_REQUIRES_(
                                 ConvertibleTo<Arg, Reference>() &&
                                 std::is_assignable<semiregular_t<Reference> &, Arg>::value)>
                    std::experimental::suspend_always yield_value(Arg &&arg) noexcept(
                ...
                struct sized_generator_promise : generator_promise<Reference>
                {
                    ...
                    {
                        // sized_generator doesn't suspend at its initial suspend point
                        // because...
                        return {};
                    }
