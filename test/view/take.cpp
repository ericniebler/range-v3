...
int main()
{
    ...
    models<concepts::BoundedView>(rng0b);
    models<concepts::SizedView>(rng0b);
    ...
    models<concepts::View>(rng3b);
    models_not<concepts::BoundedView>(rng3b);
    models<concepts::SizedView>(rng3b);
    ...
    ::models_not<concepts::SizedView>(rng6);
    ...
    ::models_not<concepts::SizedView>(rng8);
    check_equal(rng8, {0, 1, 2, 3, 4});

    auto rng9 = rl | view::take(20);
    ::models<concepts::BidirectionalRange>(rng9);
    ::models_not<concepts::BoundedView>(rng9);
    ::models_not<concepts::SizedView>(rng9);
