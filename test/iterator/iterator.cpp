...
void deep_integration_test()
{
    ...
    static_assert(is_same<iter_difference_t<std::int_least16_t>, std::int_fast32_t>::value, "");
    static_assert(is_same<iter_difference_t<std::uint_least16_t>, std::int_fast32_t>::value, "");
    static_assert(is_same<iter_difference_t<std::int_least32_t>, std::int_fast64_t>::value, "");
    static_assert(is_same<iter_difference_t<std::uint_least32_t>, std::int_fast64_t>::value, "");
    static_assert(is_same<iter_difference_t<std::uint_least64_t>, std::intmax_t>::value, "");
