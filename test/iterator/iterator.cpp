...
void deep_integration_test()
{
    ...
    static_assert(detail::is_std_iterator_traits_specialized_v<_X>, "");
    static_assert(is_same<typename iterator_traits<_X>::value_type, int>::value, "");
    static_assert(is_same<iter_value_t<_X>, int>::value, "");

    static_assert(!detail::is_std_iterator_traits_specialized_v<_Y>, "");
    ...
    static_assert(!detail::is_std_iterator_traits_specialized_v<_Z>, "");
