...
int main()
{
    ...
    // Test rvalue ranges
    {
        ...
        auto res = ranges::set_difference(ranges::make_iterator_range(ia), ranges::make_iterator_range(ib), ic, std::less<int>(), &S::i, &T::j);
        ...
        int irr[] = {6};
        static const int srr = sizeof(irr)/sizeof(irr[0]);
        auto res2 = ranges::set_difference(ranges::make_iterator_range(ib), ranges::make_iterator_range(ia), ic, std::less<int>(), &T::j, &S::i);
