...
#ifdef RANGES_CXX_GREATER_THAN_11
    {
    static_assert(constexpr_test<input_iterator<const int*>, output_iterator<int*> >(), "");
    static_assert(constexpr_test<input_iterator<const int*>, input_iterator<int*> >(), "");
    static_assert(constexpr_test<input_iterator<const int*>, forward_iterator<int*> >(), "");
    static_assert(constexpr_test<input_iterator<const int*>, bidirectional_iterator<int*> >(), "");
    static_assert(constexpr_test<input_iterator<const int*>, random_access_iterator<int*> >(), "");
    static_assert(constexpr_test<input_iterator<const int*>, int*>(), "");

    static_assert(constexpr_test<forward_iterator<const int*>, output_iterator<int*> >(), "");
    static_assert(constexpr_test<forward_iterator<const int*>, input_iterator<int*> >(), "");
    static_assert(constexpr_test<forward_iterator<const int*>, forward_iterator<int*> >(), "");
    static_assert(constexpr_test<forward_iterator<const int*>, bidirectional_iterator<int*> >(), "");
    static_assert(constexpr_test<forward_iterator<const int*>, random_access_iterator<int*> >(), "");
    static_assert(constexpr_test<forward_iterator<const int*>, int*>(), "");

    static_assert(constexpr_test<bidirectional_iterator<const int*>, output_iterator<int*> >(), "");
    static_assert(constexpr_test<bidirectional_iterator<const int*>, input_iterator<int*> >(), "");
    static_assert(constexpr_test<bidirectional_iterator<const int*>, forward_iterator<int*> >(), "");
    static_assert(constexpr_test<bidirectional_iterator<const int*>, bidirectional_iterator<int*> >(), "");
    static_assert(constexpr_test<bidirectional_iterator<const int*>, random_access_iterator<int*> >(), "");
    static_assert(constexpr_test<bidirectional_iterator<const int*>, int*>(), "");

    static_assert(constexpr_test<random_access_iterator<const int*>, output_iterator<int*> >(), "");
    static_assert(constexpr_test<random_access_iterator<const int*>, input_iterator<int*> >(), "");
    static_assert(constexpr_test<random_access_iterator<const int*>, forward_iterator<int*> >(), "");
    static_assert(constexpr_test<random_access_iterator<const int*>, bidirectional_iterator<int*> >(), "");
    static_assert(constexpr_test<random_access_iterator<const int*>, random_access_iterator<int*> >(), "");
    static_assert(constexpr_test<random_access_iterator<const int*>, int*>(), "");

    static_assert(constexpr_test<const int*, output_iterator<int*> >(), "");
    static_assert(constexpr_test<const int*, input_iterator<int*> >(), "");
    static_assert(constexpr_test<const int*, forward_iterator<int*> >(), "");
    static_assert(constexpr_test<const int*, bidirectional_iterator<int*> >(), "");
    static_assert(constexpr_test<const int*, random_access_iterator<int*> >(), "");
    static_assert(constexpr_test<const int*, int*>(), "");

    static_assert(constexpr_test<input_iterator<const int*>, output_iterator<int*>, sentinel<const int*>>(), "");
    static_assert(constexpr_test<input_iterator<const int*>, input_iterator<int*>, sentinel<const int*> >(), "");
    static_assert(constexpr_test<input_iterator<const int*>, forward_iterator<int*>, sentinel<const int*> >(), "");
    static_assert(constexpr_test<input_iterator<const int*>, bidirectional_iterator<int*>, sentinel<const int*> >(), "");
    static_assert(constexpr_test<input_iterator<const int*>, random_access_iterator<int*>, sentinel<const int*> >(), "");

    static_assert(constexpr_test<forward_iterator<const int*>, output_iterator<int*>, sentinel<const int*> >(), "");
    static_assert(constexpr_test<forward_iterator<const int*>, input_iterator<int*>, sentinel<const int*> >(), "");
    static_assert(constexpr_test<forward_iterator<const int*>, forward_iterator<int*>, sentinel<const int*> >(), "");
    static_assert(constexpr_test<forward_iterator<const int*>, bidirectional_iterator<int*>, sentinel<const int*> >(), "");
    static_assert(constexpr_test<forward_iterator<const int*>, random_access_iterator<int*>, sentinel<const int*> >(), "");

    static_assert(constexpr_test<bidirectional_iterator<const int*>, output_iterator<int*>, sentinel<const int*> >(), "");
    static_assert(constexpr_test<bidirectional_iterator<const int*>, input_iterator<int*>, sentinel<const int*> >(), "");
    static_assert(constexpr_test<bidirectional_iterator<const int*>, forward_iterator<int*>, sentinel<const int*> >(), "");
    static_assert(constexpr_test<bidirectional_iterator<const int*>, bidirectional_iterator<int*>, sentinel<const int*> >(), "");
    static_assert(constexpr_test<bidirectional_iterator<const int*>, random_access_iterator<int*>, sentinel<const int*> >(), "");

    static_assert(constexpr_test<random_access_iterator<const int*>, output_iterator<int*>, sentinel<const int*> >(), "");
    static_assert(constexpr_test<random_access_iterator<const int*>, input_iterator<int*>, sentinel<const int*> >(), "");
    static_assert(constexpr_test<random_access_iterator<const int*>, forward_iterator<int*>, sentinel<const int*> >(), "");
    static_assert(constexpr_test<random_access_iterator<const int*>, bidirectional_iterator<int*>, sentinel<const int*> >(), "");
    static_assert(constexpr_test<random_access_iterator<const int*>, random_access_iterator<int*>, sentinel<const int*> >(), "");
    }
#endif
