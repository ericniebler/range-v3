...
int main()
{
    ...
    // Test projections
    {
        ...
        auto res = ranges::set_union(ranges::make_iterator_range(ia), ranges::make_iterator_range(ib), ic, std::less<int>(), &S::i, &T::j);
        ...
        auto res2 = ranges::set_union(ranges::make_iterator_range(ib), ranges::make_iterator_range(ia), ic, std::less<int>(), &T::j, &S::i);
